...
public class Messages {
    ...
    public static class TrackSelectionsMessage {
        ...
        Map<String, Object> toMap() {
            ...
            toMapResult.put("trackType", trackType);
            return toMapResult;
        }
        ...
        static TrackSelectionsMessage fromMap(Map<String, Object> map) {
            ...
            if (trackIndex instanceof Integer) {
                fromMapResult.trackIndex = (int) trackIndex;
            }
            Object trackType = map.get("trackType");
            if (trackType instanceof Integer) {
                fromMapResult.trackType = (int) trackType;
            }
            return fromMapResult;
        }
        ...
        static @NonNull TrackSelectionsMessage fromList(@NonNull ArrayList<Object> list) {
            ...
            pigeonResult.setTrackIndex(
                    (trackIndex == null)
                            ? -1
                            : (int) trackIndex);

            pigeonResult.setTrackType(
                    (trackType == null)
                            ? -1
                            : (int) trackType);
            return pigeonResult;
